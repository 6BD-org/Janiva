 ...
 * expressed in using this base class for {@link JXLogicalAndNode} and {@link JXLogicalOrNode}.
 */
public abstract class JXShortCircuitNode extends JXExpressionNode {

  @Child private JXExpressionNode left;
  @Child private JXExpressionNode right;
  ...
  public JXShortCircuitNode(JXExpressionNode left, JXExpressionNode right) {
    this.left = left;
    this.right = right;
  }
