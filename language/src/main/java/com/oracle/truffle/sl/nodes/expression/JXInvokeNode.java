...
public final class JXInvokeNode extends JXExpressionNode {

  @Child private JXExpressionNode functionNode;
  @Children private final JXExpressionNode[] argumentNodes;
  @Child private InteropLibrary library;

  public JXInvokeNode(JXExpressionNode functionNode, JXExpressionNode[] argumentNodes) {
