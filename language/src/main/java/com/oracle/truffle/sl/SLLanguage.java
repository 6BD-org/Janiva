 ...
 *       SLBigNumber} for numbers that exceed the range. Using a primitive type such as {@code long}
...
public final class SLLanguage extends TruffleLanguage<SLContext> {
  ...
  public RootCallTarget lookupBuiltin(NodeFactory<? extends SLBuiltinNode> factory) {
    ...
    TruffleString name =
        SLStrings.fromJavaString(lookupNodeInfo(builtinBodyNode.getClass()).shortName());
