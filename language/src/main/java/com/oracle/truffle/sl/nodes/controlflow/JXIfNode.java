...
public final class JXIfNode extends JXStatementNode {
  ...
  @Child private JXStatementNode thenPartNode;

  /** Statement (or {@link SLBlockNode block}) executed when the condition is false. */
  @Child private JXStatementNode elsePartNode;
  ...
  public JXIfNode(
          JXExpressionNode conditionNode, JXStatementNode thenPartNode, JXStatementNode elsePartNode) {
