 ...
 *
 * <ol>
 *   <li>evaluates the object expression on the left hand side of the object access operator
 *   <li>evaluates the property name
 *   <li>evaluates the value expression on the right hand side of the assignment operator
 *   <li>writes the named property
 *   <li>returns the written value
 * </ol>
 */
@NodeInfo(shortName = ".=")
...
@NodeChild("nameNode")
@NodeChild("valueNode")
public abstract class JXWritePropertyNode extends JXExpressionNode {

  static final int LIBRARY_LIMIT = 3;

  @Specialization(guards = "arrays.hasArrayElements(receiver)", limit = "LIBRARY_LIMIT")
  protected Object writeArray(
      Object receiver,
      Object index,
      Object value,
