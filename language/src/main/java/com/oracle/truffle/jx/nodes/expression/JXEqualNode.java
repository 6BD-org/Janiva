 ...
 * Object) implementation} that can handle all possible types including interop types.
 *
 * <p>Note that we do not need the analogous {@code !=} operator, because we can just {@link
 * JXLogicalNotNode negate} the {@code ==} operator.
 */
@NodeInfo(shortName = "==")
public abstract class JXEqualNode extends JXBinaryNode {
