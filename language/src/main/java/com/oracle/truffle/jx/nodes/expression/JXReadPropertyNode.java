 ...
 *   <li>evaluated the property name
 *   <li>reads the named property
 * </ol>
 */
@NodeInfo(shortName = ".")
@NodeChild("receiverNode")
@NodeChild("nameNode")
public abstract class JXReadPropertyNode extends JXExpressionNode {
  ...
  @Specialization(
      guards = {"!isSLObject(receiver)", "objects.hasMembers(receiver)"},
      limit = "LIBRARY_LIMIT")
