...
public abstract class JXRangeNode extends JXExpressionNode {
  ...
  public Object doLong(VirtualFrame frame, @CachedLibrary(limit = "1") InteropLibrary library)
  ...
  public Object doString(VirtualFrame frame, @CachedLibrary(limit = "1") InteropLibrary library)
      throws UnsupportedMessageException {
