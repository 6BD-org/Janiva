...
import com.oracle.truffle.api.frame.VirtualFrame;import com.oracle.truffle.api.interop.*;
...
public abstract class JXStdoutNode extends JXExpressionNode {
  ...
  public Object executeObject(
    ...
    try {
      IOUtils.writeJanivaObjectIntoStream(InteropLibrary.getUncached(), System.out, frame.getArguments()[0]);
