...
@NodeInfo(shortName = "-")
public abstract class JXSubNode extends JXBinaryNode {
  ...
  @Specialization
  @TruffleBoundary
  protected JXBigNumber sub(JXBigNumber left, JXBigNumber right) {
    return new JXBigNumber(left.getValue().subtract(right.getValue()));
  }
