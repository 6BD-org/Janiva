 ...
 *
 * <p>The isInstance type checks are declared using an functional interface and are expressed using
 * the interoperability libraries. The advantage of this is type checks automatically work for
 * foreign values or primitive values like byte or short.
 *
 * <p>The class implements the interop contracts for {@link InteropLibrary#isMetaObject(Object)} and
 ...
 * assigned using language views. See {@link JanivaLang#getLanguageView}.
 */
...
public final class JXType implements TruffleObject {
  ...
  /*
   * All JanivaTypes are declared as interop meta-objects. Other example for meta-objects are Java
