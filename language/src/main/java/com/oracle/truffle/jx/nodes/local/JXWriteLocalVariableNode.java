...
@NodeField(name = "nameNode", type = JXExpressionNode.class)
@NodeField(name = "declaration", type = boolean.class)
public abstract class JXWriteLocalVariableNode extends JXExpressionNode {
   ...
   */
  protected abstract JXExpressionNode getNameNode();
  ...
  public Object getNodeObject() {
    JXExpressionNode nameNode = getNameNode();
