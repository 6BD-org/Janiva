...
/** This class is similar to the {@link JXLessThanNode}. */
@NodeInfo(shortName = "<=")
public abstract class JXLessOrEqualNode extends JXBinaryNode {
  ...
  @Specialization
  @TruffleBoundary
  protected boolean lessOrEqual(JXBigNumber left, JXBigNumber right) {
